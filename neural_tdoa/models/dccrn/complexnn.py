...
class ComplexConvTranspose2d(nn.Module):
    ...
    def __init__(
        ...
        self.real_conv = nn.ConvTranspose2d(self.in_channels, self.out_channels, kernel_size,
                                            self.stride, padding=self.padding, output_padding=output_padding, groups=self.groups)
        self.imag_conv = nn.ConvTranspose2d(self.in_channels, self.out_channels, kernel_size,
                                            self.stride, padding=self.padding, output_padding=output_padding, groups=self.groups)
        self.complex_axis = complex_axis
...
if __name__ == '__main__':
    ...
    onet2 = dc_crn7.ComplexConvTranspose2d(
        12, 12, kernel_size=(3, 2), padding=(2, 1))
    inputs = torch.randn([1, 12, 12, 10])
#    print(onet1.real_kernel[0,0,0,0])
    nnet1 = ComplexConv2d(12, 12, kernel_size=(3, 2),
                          padding=(2, 1), causal=True)
